...
func handlerLogin(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		http.Error(w, "Failed to rend user data from ES", http.StatusInternalServerError)

		return
	}

	if !exists {
		http.Error(w, "User doesn't exist or wrong password", http.StatusInternalServerError)
		return
	}
